...
@Component({
  selector: 'app-salesservicepersontype',
  templateUrl: './salesservicepersontype.component.html',
  styleUrls: ['../../../../assets/css/configuration/configuration.css'],
  providers: [SalesservicepersontypeService]
})
export class SalesservicepersontypeComponent implements OnInit {
  ...
  dataSource: MatTableDataSource<SalesservicepersontypeData>;
  ...
  getData() {
    ...
    this.SalesservicepersontypeService.getSSPTData()
      .subscribe(res => {
        this.codesList = res;
      ...
      err => {
        this.errorMsg = "Sales/Service Person Type codes not found.";
  ...
  callSSPTCodes() {
    ...
    this.code = "";
    this.description = "";
    this.pgTitle = "Add Sales/Service Person Type Code";
  }
  addSSPTcodeback() {
    this.addFlag = false;
  ...
  saveSSPTcode(value) {
    ...
    if (this.codeForm.valid) {
      ...
      this.SalesservicepersontypeService.submitSSPT(body)
        .subscribe(res => {
          this.addFlag = false;
          this.codesList = "";
          this.displayFlag = true;
  ...
  editSSPTcodes(id, code, desc, startDate, endDate, isSystem) {
    this.editFlag = true;
    this.displayFlag = false;
    this.editcode = code;
    ...
    this.pgTitle = "Edit Sales/Service Person Type Code";
  }
  updateSSPTeditcode(code, value) {
    this.editerrormsg = "";
    if (this.codeeditForm.valid) {
      ...
      this.SalesservicepersontypeService.updateSSPT(this.id, body)
        .subscribe(res => {
          this.editFlag = false;
          this.codesList = "";
          this.displayFlag = true;
...
export interface SalesservicepersontypeData {
  Id: any;
  Code: any;
  StartDate: any;
  EndDate: any;
