...
import { ServiceorderreasonService } from '../../../_services/servcieorderreason.service';

@Component({
  selector: 'app-serviceorderreason',
  templateUrl: './serviceorderreason.component.html',
  styleUrls: ['../../../../assets/css/configuration/configuration.css'],
  providers: [ServiceorderreasonService]
})
export class ServiceorderreasonComponent implements OnInit {
  ...
  editerrormsg: string = "";
  pgTitle: string = "Service Order Reason";
  minDate: Date;
  pager: any = {};
  pagedItems: any[];
  selectpage: number = 1;
  ...
  constructor(private fb: FormBuilder,
    ...
    private http: Http,
    private ServiceorderreasonService: ServiceorderreasonService, private pagerService: PagerService) {
    this.sortby = "Code";
    this.sortorder = "asc";
    this.getData();
  }
  ...
  dataSource: MatTableDataSource<ServiceorderreasonData>;
  ...
  getData() {
    ...
    this.ServiceorderreasonService.getSORData()
      .subscribe(res => {
        this.codesList = res;
  ...
  callSORCodes() {
    ...
    this.code = "";
    this.description = "";
    this.pgTitle = "Add Service Order Reason Code";
  }
  addSORcodeback() {
    this.addFlag = false;
    ...
    this.description = "";
    this.getData();
    this.pgTitle = "Service Order Reason";
  }
  clearSORaddcodes() {
    this.code = "";
    this.description = "";
  ...
  saveSORcode(value) {
    ...
    if (this.codeForm.valid) {
      ...
      this.ServiceorderreasonService.submitSOR(body)
        .subscribe(res => {
          this.addFlag = false;
          this.codesList = "";
          this.displayFlag = true;
  ...
  editSORcodes(id, code, desc, startDate, endDate, isSystem) {
    this.editFlag = true;
    this.displayFlag = false;
    this.editcode = code;
    ...
    this.pgTitle = "Edit Service Order Reason Code";
  }
  updateSOReditcode(code, value) {
    this.editerrormsg = "";
    if (this.codeeditForm.valid) {
      ...
      this.ServiceorderreasonService.updateSOR(this.id, body)
        .subscribe(res => {
          this.editFlag = false;
          this.codesList = "";
          this.displayFlag = true;
...
export interface ServiceorderreasonData {
  Id: any;
  Code: any;
  StartDate: any;
  EndDate: any;
