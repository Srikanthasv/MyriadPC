...
import { ModelpriceService } from '../../../_services/modelprice.service';

@Component({
  selector: 'app-modelprice',
  templateUrl: './modelprice.component.html',
...
export class ModelpriceComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private http: Http,
    private ModelpriceService: ModelpriceService, private pagerService: PagerService) {
    this.sortby = "Code";
    this.sortorder = "asc";
    this.getData();
  }
  ...
  getData() {
    ...
    this.ModelpriceService.getMPData()
      .subscribe(res => {
        this.codesList = res;
      ...
      err => {
        this.errorMsg = "Model Price codes not found.";
  ...
  callMPCodes() {
    ...
    this.code = "";
    this.description = "";
    this.pgTitle = "Add Model Price Code";
  }
  addMPcodeback() {
    this.addFlag = false;
  ...
  saveMPcode(value) {
    ...
    if (this.codeForm.valid) {
      ...
      this.ModelpriceService.submitMP(body)
        .subscribe(res => {
          this.addFlag = false;
          this.codesList = "";
          this.displayFlag = true;
  ...
  editMPcodes(id, code, desc, startDate, endDate) {
    ...
    this.pgTitle = "Edit Model Price Code";
  }
  updateMPeditcode(code, value) {
    ...
    if (this.codeeditForm.valid) {
      ...
      this.ModelpriceService.updateMP(this.id, body)
        .subscribe(res => {
          this.editFlag = false;
          this.codesList = "";
          this.displayFlag = true;
