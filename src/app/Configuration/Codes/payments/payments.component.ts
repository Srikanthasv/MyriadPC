...
export class PaymentComponent implements OnInit {
  ...
  editerrormsg: string = "";
  pgTitle: string = "Method of Payment";
  minDate: Date;
  pager: any = {};
  pagedItems: any[];
  selectpage: number = 1;
  ...
  constructor(private fb: FormBuilder,
    ...
    private http: Http,
    private PaymentService: PaymentService, private pagerService: PagerService) {
    this.sortby = "Code";
    this.sortorder = "asc";
    this.getData();
  }
  ...
  getData() {
    ...
    this.PaymentService.getMPData()
      ...
      err => {
        this.errorMsg = "Method of Payment codes not found.";
  ...
  callMPCodes() {
    ...
    this.code = "";
    this.description = "";
    this.pgTitle = "Add Method of Payment Code";
  }
  addMPcodeback() {
    this.addFlag = false;
    ...
    this.description = "";
    this.getData();
    this.pgTitle = "Method of Payments";
  }
  clearMPaddcodes() {
    this.code = "";
    this.description = "";
  ...
  saveMPcode(value) {
    ...
    if (this.codeForm.valid) {
      ...
      this.PaymentService.submitMP(body)
        .subscribe(res => {
          this.addFlag = false;
          this.codesList = "";
          this.displayFlag = true;
  ...
  editMPcodes(id, code, desc, startDate, endDate, isSystem) {
    this.editFlag = true;
    this.displayFlag = false;
    this.editcode = code;
    ...
    this.pgTitle = "Edit Method of Payment Code";
  }
  updateMPeditcode(code, value) {
    ...
    if (this.codeeditForm.valid) {
      ...
      this.PaymentService.updateMP(this.id, body)
        .subscribe(res => {
          this.editFlag = false;
          this.codesList = "";
          this.displayFlag = true;
          this.getData();
          this.id = "";
          this.pgTitle = "Method of Payment";
          this.setPage(1);
        },
        err => {
          err = err
