...
@Component({
  ...
  templateUrl: './soreferral.component.html',
  styleUrls: ['../../../../assets/css/configuration/configuration.css'],
  providers: [SoreferralService]
})
export class SoreferralComponent implements OnInit {
  ...
  dataSource: MatTableDataSource<SoReferralData>;
  ...
  getData() {
    ...
    this.SoreferralService.getSoReferralData()
      .subscribe(res => {
        this.codesList = res;
      ...
      err => {
        this.errorMsg = "Sales Order Referral codes not found.";
  ...
  callSORCodes() {
    ...
    this.code = "";
    this.description = "";
    this.pgTitle = "Add Sales Order Referral Code";
  }
  addSORcodeback() {
    this.addFlag = false;
  ...
  saveSORcode(value) {
    ...
    if (this.codeForm.valid) {
      ...
      this.SoreferralService.submitSoReferral(body)
        .subscribe(res => {
          this.addFlag = false;
          this.codesList = "";
          this.displayFlag = true;
  ...
  editSORcodes(id, code, desc, startDate, endDate) {
    this.editFlag = true;
    this.displayFlag = false;
    this.editcode = code;
    ...
    this.pgTitle = "Edit Sales Order Referral Code";
  }
  updateSOReditcode(code, value) {
    ...
    if (this.codeeditForm.valid) {
      ...
      this.SoreferralService.updateSoReferral(this.id, body)
        .subscribe(res => {
          this.editFlag = false;
          this.codesList = "";
          this.displayFlag = true;
...
export interface SoReferralData {
  Id: any;
  Code: any;
  StartDate: any;
  EndDate: any;
