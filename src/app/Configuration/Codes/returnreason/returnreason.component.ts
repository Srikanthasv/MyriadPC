...
import { ReturnreasonService } from '../../../_services/returnreason.service';

@Component({
  selector: 'app-returnreason',
...
export class ReturnreasonComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private http: Http,
    private ReturnreasonService: ReturnreasonService, private pagerService: PagerService) {
    this.sortby = "Code";
    this.sortorder = "asc";
    this.getData();
  }
  ...
  dataSource: MatTableDataSource<ReturnReasonData>;
  ...
  getData() {
    ...
    this.ReturnreasonService.getRRData()
      .subscribe(res => {
        this.codesList = res;
      ...
      err => {
        this.errorMsg = "Return Reason codes not found.";
  ...
  callRRCodes() {
    ...
    this.code = "";
    this.description = "";
    this.pgTitle = "Add Return Reason Code";
  }
  addRRcodeback() {
    this.addFlag = false;
  ...
  saveRRcode(value) {
    ...
    if (this.codeForm.valid) {
      ...
      this.ReturnreasonService.submitRR(body)
        .subscribe(res => {
          this.addFlag = false;
          this.codesList = "";
          this.displayFlag = true;
  ...
  editRRcodes(id, code, desc, startDate, endDate) {
    this.editFlag = true;
    this.displayFlag = false;
    this.editcode = code;
    ...
    this.pgTitle = "Edit Return Reason Code";
  }
  updateRReditcode(code, value) {
    this.editerrormsg = "";
    if (this.codeeditForm.valid) {
      ...
      this.ReturnreasonService.updateRR(this.id, body)
        .subscribe(res => {
          this.editFlag = false;
          this.codesList = "";
          this.displayFlag = true;
