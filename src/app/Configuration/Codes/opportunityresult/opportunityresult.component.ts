...
@Component({
  selector: 'app-opportunityresult',
  templateUrl: './opportunityresult.component.html',
...
export class OpportunityresultComponent implements OnInit {
  ...
  getData() {
    ...
    this.OpportunityresultService.getORData()
      .subscribe(res => {
        this.codesList = res;
      ...
      err => {
        this.errorMsg = "Opportunity result codes not found.";
  ...
  callORCodes() {
    ...
    this.code = "";
    this.description = "";
    this.pgTitle = "Add Opportunity Result Code";
  }
  addORcodeback() {
    this.addFlag = false;
  ...
  saveORcode(value) {
    ...
    if (this.codeForm.valid) {
      ...
      this.OpportunityresultService.submitOR(body)
        .subscribe(res => {
          this.addFlag = false;
          this.codesList = "";
          this.displayFlag = true;
  ...
  editORcodes(id, code, desc, startDate, endDate, isSystem) {
    this.editFlag = true;
    this.displayFlag = false;
    this.editcode = code;
    ...
    this.pgTitle = "Edit Opportunity Result";
    this.IsSystem = isSystem;
  }
  updateOReditcode(code, value) {
    this.editerrormsg = "";
    if (this.codeeditForm.valid) {
      ...
      this.OpportunityresultService.updateOR(this.id, body)
        .subscribe(res => {
          this.editFlag = false;
          this.codesList = "";
          this.displayFlag = true;
...
export interface OpportunityResultData {
  Id: any;
  Code: any;
  StartDate: any;
  EndDate: any;
